    ...
    <>
      <div class="font-sans rounded-md border px-6 py-4 max-w-md">
        <div class="flex items-center">
          <img
            src="https://pbs.twimg.com/profile_images/1488434260860182529/uCD5L1hQ_400x400.jpg"
          ...
          <div class="flex flex-col ml-4">
            ...
            <span class="text-grey">@MorganEmilyJane</span>
          </div>
          <svg
        ...
        <div class=" mt-3 mb-1 leading-normal text-lg">
          It’s a pretty gnarly afternoon session, compared to this morning.
          simply greedy stance from the event runners. They know full well how
          many tickets they have sold (and can cap) 🙊 Thank god for the Sake 🥂
        </div>
